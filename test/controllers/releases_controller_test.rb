...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { name: @release.name, pillar_id: @release.pillar_id, scope_id: @release.scope_id }
    end
  ...
  test "should update release" do
    patch :update, id: @release, release: { name: @release.name, pillar_id: @release.pillar_id, scope_id: @release.scope_id }
    assert_redirected_to release_path(assigns(:release))
  end
